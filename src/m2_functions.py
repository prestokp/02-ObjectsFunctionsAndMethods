...
def main():
    ...
    turtle_function("Red", 10)
    turtle_function("Blue", 15)
...
#
###############################################################################
def turtle_function(color, thickness):
    window = rg.TurtleWindow()
    elon = rg.SimpleTurtle()
    elon.pen=rg.Pen("Green", thickness)
    shotwell = rg.SimpleTurtle()
    shotwell.pen=rg.Pen(color, 5)
    elon.forward(100)
    shotwell.backward(100)
